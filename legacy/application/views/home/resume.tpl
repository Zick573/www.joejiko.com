<article id="page-resume" class="resume">
  ...
  <article class="grid-8">
    <section id="objective">
      <h2>Objective</h2>
      <article>
        <p>To pursue a career in the fields of Website Development, Mobile applications, Graphic Design, Illustration, Information Systems, or Information Technology (I like to do a lot of things!).</p>
      </article>
    </section>
    ...
    <section id="proficiency">
      <h2>Proficient In</h2>
      <article>
        <p>Microsoft Windows XP, Vista, 7, Mac OS X, iOS, Android</p>
        ...
        <p>Microsoft Office: Word, Excel, PowerPoint, Publisher</p>
        <p>PHP/MySQL, HTML5, CSS3, JavaScript, jQuery, oAUTH</p>
        <p>Facebook Graph API, Google APIs, Google analytics, Twitter API, etc.</li>
        <p>Smarty (templating engine)</p>
      </article>
      <h2>Other libraries and systems I've tried or like</h2>
      <article>
        <ul>
          <li>ModX</li>
          <li>Prestashop</li>
    ...
    <section id="strengths">
      ...
      <article>
        <ul>
          <li>Creating unique, visually appealing websites and web applications using the latest web technologies such as HTML5, CSS3, and jQuery (a JavaScript library) {literal}{note: I don't just use jQuery plugins and I understand regular javascript too.}{/literal}</li>
          <li>User interfaces and positive user experience.</li>
          <li>Website development, redesign, and maintenance.</li>
          <li>Responsive web design (designing for multiple platforms and screen sizes).</li>
          <li>CMS theming and customization: Magento Ecommerce, WordPress, BigCartel, Etc.</li>
          <li>Web hosting and server configuration</li>
          <li>Database planning</li>
          <li>Cross-browser compatibility (except anything older than IE8)</li>
          <li>PC troubleshooting, installations, and repair. Network installation and configuration.</li>
