...
class Hybrid_Providers_Google extends Hybrid_Provider_Model_OAuth2
{
	...
	*/
	function getUserProfile()
	{
		...
		$this->user->profile->email         = (property_exists($response,'emails'))?$response->emails:"";
		...
		$this->user->profile->region        = (property_exists($response,'placesLived'))?$response->placesLived:"";
		$this->user->profile->webSiteURL    = (property_exists($response,'urls'))?$response->urls:"";
