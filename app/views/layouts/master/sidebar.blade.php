...
<!-- <div class="sidebar-module">
  ...
  <header class="module-header">
    <h2>Music &ndash; Recently played</h2>
    <div data-widget="music-feed" data-feed-count="3"></div>
  </header>

  <p>i guess this text is distracting</p>

  <p>if you think so, maybe <a class="module-link" href="#">click here</a></p>

  <p>otherwise <a class="module-link" href="#">click this</a></p>
