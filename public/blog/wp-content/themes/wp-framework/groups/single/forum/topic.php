<?php
/**
 * BuddyPress Template: Group Forum Topic
 *
...
<?php if ( bp_has_forum_topic_posts() ) : ?>
	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<div class="pagination no-ajax">
			...
			</div><!-- #post-count .pag-count -->

			<div class="pagination-links" id="topic-pag">
				<?php bp_the_topic_pagination(); ?>
			</div><!-- #topic-pag .pagination-links -->
			...
			<?php while ( bp_forum_topic_posts() ) : bp_the_forum_topic_post(); ?>
				...
				<li id="post-<?php bp_the_topic_post_id(); ?>" class="<?php bp_the_topic_post_css_class(); ?>">
					<div class="poster-meta">
						...
						<?php echo sprintf( __( '%s said %s ago:', t() ), bp_get_the_topic_post_poster_name(), bp_get_the_topic_post_time_since() ); ?>
					</div><!-- .poster-meta -->
					...
					<div class="admin-links">
						...
						<a href="#post-<?php bp_the_topic_post_id(); ?>" title="<?php _e( 'Permanent link to this post', t() ); ?>">#</a>
					</div><!-- .admin-links -->
				</li>
			...
			<?php if ( bp_get_the_topic_is_last_page() ) : ?>
				...
				<?php if ( bp_get_the_topic_is_topic_open() ) : ?>
					...
					<div id="post-topic-reply">
						<p id="post-reply"></p><!-- #post-reply -->

						<?php if ( bp_groups_auto_join() && !bp_group_is_member() ) : ?>
							<p><?php _e( 'You will auto join this group when you reply to this topic.', t() ); ?></p>
						<?php endif; ?>

						<?php do_action( 'groups_forum_new_reply_before' ); ?>

						<h4><?php _e( 'Add a reply:', t() ); ?></h4>

						<textarea name="reply_text" id="reply_text"></textarea>

						<?php submit_button( __( 'Post Reply', t() ), 'primary', 'submit', true, array( 'name' => 'submit_reply' ) ); ?>
				...
				<?php else : ?>
					...
					<?php wpf_message( __( 'This topic is closed, replies are no longer accepted.', t() ), 'info' ); ?>
...
<?php else: ?>
	...
	<?php wpf_message( __( 'There are no posts for this topic.', t() ), 'info' ); ?>
