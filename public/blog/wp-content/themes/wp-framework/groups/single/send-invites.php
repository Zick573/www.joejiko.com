<?php
/**
 * BuddyPress Template: Send Invites
 *
...
<?php if ( bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
	...
	<form action="<?php bp_group_send_invite_form_action(); ?>" method="post" id="send-invite-form" class="standard-form">
		...
		<div class="main-column">
			...
			<?php wpf_message( __( 'Select people to invite from your friends list.', t() ), 'info' ); ?>
			...
			<?php if ( bp_group_has_invites() ) : ?>
				...
				<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
					...
					<li id="<?php bp_group_invite_item_id(); ?>">
						...
						<span class="activity"><?php bp_group_invite_user_last_active(); ?></span><!-- .activity -->
		...
		<?php submit_button( __( 'Send Invites', t() ), 'primary', 'submit' ); ?>
	...
	</form><!-- #send-invite-form .standard-form -->
