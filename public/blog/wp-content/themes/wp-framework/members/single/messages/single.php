<?php
/**
 * BuddyPress Template: Member Messages Single
 *
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<p id="message-recipients">
			<span class="highlight">
				<?php printf( __('Sent between %s and %s', t() ), bp_get_the_thread_recipients(), '<a href="' . bp_get_loggedin_user_link() . '" title="' . bp_get_loggedin_user_fullname() . '">' . bp_get_loggedin_user_fullname() . '</a>' ); ?>
			</span><!-- .highlight -->
			...
			<div class="message-box">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						...
						<strong><?php _e( 'Send a Reply', t() ); ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" name="send" value="<?php _e( 'Send Reply', t() ); ?> &rarr;" id="send_reply_button"/>
